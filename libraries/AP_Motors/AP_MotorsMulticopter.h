...
public:
    ...
    float get_throttle_thrust() const { return (_throttle_control_input-rel_pwm_to_thr_range(_min_throttle)) / (1000.0f-rel_pwm_to_thr_range(_min_throttle)); }
    ...
    float               get_throttle_warn_low_end_pct() const;

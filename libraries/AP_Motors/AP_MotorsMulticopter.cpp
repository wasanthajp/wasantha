...
// get_throttle_thrust_hover - converts hover throttle to pwm (i.e. range 1000 ~ 2000)
float AP_MotorsMulticopter::get_throttle_thrust_hover() const
{
    return (_hover_out / 1000.0f);
}

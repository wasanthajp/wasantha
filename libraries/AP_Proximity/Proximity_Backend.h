...
public:
	...
	AP_Proximity_Backend(Proximity &_proximity_sensor, uint8_t instance, Proximity::Proximity_State &_state);
    ...
    virtual bool get_horizontal_distance(int16_t angle_deg, int16_t &distance_cm);

protected:

    // set status and update valid_count
    void set_status(Proximity::Proximity_Status status);

    Proximity &proximity_sensor;
    Proximity::Proximity_State &state;
};

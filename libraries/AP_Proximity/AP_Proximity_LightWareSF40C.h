...
public:
    // constructor
    AP_Proximity_LightWareSF40C(Proximity &ranger, uint8_t instance, Proximity::Proximity_State &_state,
                                   AP_SerialManager &serial_manager);

    // static detection function
    static bool detect(Proximity &ranger, uint8_t instance, AP_SerialManager &serial_manager);
...
private:
    ...
    int16_t _distance_cm[PROXIMITY_SF40C_SECTORS];

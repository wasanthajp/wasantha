...
public:
    ...
    bool get_horizontal_distance(uint8_t instance, int16_t angle_deg, uint16_t &distance_cm) const;
    bool get_horizontal_distance(int16_t angle_deg, uint16_t &distance_cm) const;

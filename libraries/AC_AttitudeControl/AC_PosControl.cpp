...
{
#define OVERSPEED_CONTROL_Z 2.0f
    float accel_z_cms = _accel_z_cms;
    if (_vel_desired.z < _speed_down_cms) {
        accel_z_cms *= OVERSPEED_CONTROL_Z * _vel_desired.z / _speed_down_cms;
    }
    if (_vel_desired.z > _speed_up_cms) {
        accel_z_cms *= OVERSPEED_CONTROL_Z * _vel_desired.z / _speed_up_cms;
    }

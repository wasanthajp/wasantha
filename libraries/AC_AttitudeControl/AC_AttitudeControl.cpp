...
float AC_AttitudeControl::max_rate_step_bf_roll()
{
    ...
    return 2.0f*motors.get_throttle_hover()*AC_ATTITUDE_RATE_RP_CONTROLLER_OUT_MAX/((alpha_remaining*alpha_remaining*alpha_remaining*alpha*get_rate_roll_pid().kD())/_dt + get_rate_roll_pid().kP());
}
...
float AC_AttitudeControl::max_rate_step_bf_pitch()
{
    ...
    float alpha_remaining = 1-alpha;
    return 2.0f*motors.get_throttle_hover()*AC_ATTITUDE_RATE_RP_CONTROLLER_OUT_MAX/((alpha_remaining*alpha_remaining*alpha_remaining*alpha*get_rate_pitch_pid().kD())/_dt + get_rate_pitch_pid().kP());
}
...
float AC_AttitudeControl::max_rate_step_bf_yaw()
{
    ...
    float alpha_remaining = 1-alpha;
    return 2.0f*motors.get_throttle_hover()*AC_ATTITUDE_RATE_RP_CONTROLLER_OUT_MAX/((alpha_remaining*alpha_remaining*alpha_remaining*alpha*get_rate_yaw_pid().kD())/_dt + get_rate_yaw_pid().kP());
}

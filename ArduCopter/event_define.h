...
enum EventId {
    // autotune events
    EVENT_ENUM(AUTOTUNE_STARTED)
    EVENT_ENUM(AUTOTUNE_RESTARTED)
    EVENT_ENUM(AUTOTUNE_STOPPED)
    EVENT_ENUM(AUTOTUNE_SUCCESS)
    EVENT_ENUM(AUTOTUNE_FAILED)
    EVENT_ENUM(AUTOTUNE_SAVED_GAINS)
    EVENT_ENUM(AUTOTUNE_PILOTTESTING)
    // baro
    EVENT_ENUM(BARO_CALIBRATING)
    EVENT_ENUM(BARO_CALIBRATION_COMPLETE)
    // crash check events
    EVENT_ENUM(CRASHCHECK_DISARMED)
    // dataflash
    EVENT_ENUM(DATAFLASH_ERASING_LOGS)
    EVENT_ENUM(DATAFLASH_ERASE_COMPLETE)
    EVENT_ENUM(DATAFLASH_NO_DATAFLASH_INSERTED)
    // esc calibration
    EVENT_ENUM(ESC_CALIBRATION_RESTART_BOARD)
    EVENT_ENUM(ESC_CALIBRATION_PASSINGTHROUGH)
    EVENT_ENUM(ESC_CALIBRATION_AUTOCALIBRATION)
    EVENT_ENUM(ESC_CALIBRATION_PUSH_SAFETYSWITCH)
    // failsafe
    EVENT_ENUM(FAILSAFE_RADIO)
    EVENT_ENUM(FAILSAFE_EKF_VARIANCE)
    EVENT_ENUM(FAILSAFE_BATTERY_VOLTAGE_LOW)
    EVENT_ENUM(FAILSAFE_GCS)
    // ins events
    EVENT_ENUM(INS_GYRO_CAL_FAILED)
    // main autopilot events
    EVENT_ENUM(MAIN_INITIALISING)
    EVENT_ENUM(MAIN_GROUND_START)
    EVENT_ENUM(MAIN_WAITING_FOR_HIL)
    EVENT_ENUM(MAIN_ARMING)
    EVENT_ENUM(MAIN_DISARMING)
    EVENT_ENUM(MAIN_LOCATE_COPTER_ALARM)
    EVENT_ENUM(MAIN_TRIM_SAVED)
    // parachute
    EVENT_ENUM(PARACHUTE_RELEASED)
    EVENT_ENUM(PARACHUTE_FAILED_TOO_LOW)

...
bool Copter::FlightController_ALTHOLD::init(bool ignore_checks)
{
...
void Copter::FlightController_ALTHOLD::run()
{
    ...
    bool takeoff_triggered = (ap.land_complete && (channel_throttle->control_in > _copter.get_takeoff_trigger_throttle()) && motors.rotor_runup_complete());
#else
    bool takeoff_triggered = (ap.land_complete && (channel_throttle->control_in > _copter.get_takeoff_trigger_throttle()) && motors.spool_up_complete());
#endif
    ...
    } else if (_copter.takeoff_state.running || takeoff_triggered){
